...
### 2.5：将计时单位由毫妙改成了纳秒（最高精度），同时对输出进行格式化，从而获取更精细的时间戳和时间间隔。

现在运行 `./main 0.01` 的输出可能如下所示：

```text
Current timestamp: 2026-02-05 19:41:39.126630000
... (省略中间输出) ...
Current timestamp: 2026-02-05 19:41:40.297261000
Average interval 0.0117060000 seconds
P50 0.0115050000 seconds
P80 0.0121310000 seconds
P90 0.0124440000 seconds
P95 0.0125490000 seconds
P99 0.0152900000 seconds
```